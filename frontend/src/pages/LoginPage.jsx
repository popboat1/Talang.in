      ...
      <main className="relative z-10 flex min-h-screen items-center justify-center px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid w-full max-w-6xl overflow-hidden rounded-[2rem] border border-white/80 bg-white/75 shadow-[0_30px_90px_rgba(11,45,85,.14)] backdrop-blur-xl lg:grid-cols-[0.95fr_1.05fr]">
          ...
          <section className="relative hidden overflow-hidden bg-[#0b2d55] p-8 text-white lg:flex lg:flex-col lg:justify-between">
            ...
            <div className="relative login-rise">
              <button
                onClick={() => navigate('/')}
              ...
              <div className="mt-14 max-w-md">
                ...
                <h1 className="text-5xl font-black leading-[1.02] tracking-[-0.06em]">
                  Kelola patungan grup tanpa drama.
                </h1>

                <p className="mt-5 text-base leading-8 text-blue-50/72">
                  Catat transaksi, pantau balance, dan lihat rekomendasi pembayaran dalam satu tempat yang rapi.
                </p>
              </div>
            </div>

            <div className="relative login-rise" style={{ animationDelay: '120ms' }}>
              <div className="login-float rounded-[1.7rem] border border-white/12 bg-white/10 p-5 shadow-[0_24px_55px_rgba(0,0,0,.18)]">
                <div className="mb-5 flex items-center justify-between">
                  <div>
                    <p className="text-xs font-bold text-blue-100/60">Ringkasan grup</p>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    { label: 'Pengeluaran', value: 'Rp45.000' },
                  ].map((item) => (
                    <div
                      key={item.label}
                ...
                <div className="mt-4 rounded-2xl bg-white p-4 text-[#0b2d55]">
                  <div className="flex items-center justify-between">
                    <p className="text-sm font-black">Status balance</p>
                  ...
                  <div className="mt-4 h-2 rounded-full bg-slate-100">
                    <div className="h-full w-[72%] rounded-full bg-[#0b2d55]" />
                  </div>

                  <p className="mt-3 text-xs font-semibold text-slate-500">
                    72% pembayaran sudah tercatat dengan jelas.
                  </p>
                </div>
              </div>
            </div>
          ...
          {/* RIGHT SIDE */}
          <section className="flex min-h-[640px] items-center justify-center px-5 py-8 sm:px-8 lg:px-12">
            <div className="login-rise w-full max-w-md">
              ...
              <div className="mb-8">
                ...
                <p className="mt-3 text-sm leading-6 text-slate-500">
                  Lanjutkan mengelola transaksi dan balance grup kamu.
                </p>
              </div>

              {error && (
                <div className="mb-5 login-rise rounded-2xl border border-red-200 bg-red-50 px-4 py-3">
              ...
              <p
                className="mt-3 cursor-pointer text-right text-xs font-black text-[#123f73] transition hover:opacity-75"
              >
                Lupa password?
              </p>
