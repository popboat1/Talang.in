  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-[1080px] overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-[0_32px_80px_rgba(14,30,80,0.08)] lg:grid lg:grid-cols-[42%_58%]">
        <div className="relative bg-[#eff4fb] p-10 lg:p-12">
          <div
          ...
          <div className="relative z-10 flex h-full flex-col justify-center gap-6">
            ...
            <div className="flex flex-col gap-3">
              <div className="rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-[0_14px_30px_rgba(11,45,85,0.08)]">
                <p className="text-[10px] uppercase tracking-[0.12em] text-slate-500">Total grup</p>
                <p className="mt-1 text-sm font-semibold text-slate-900">3 aktif</p>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-[0_14px_30px_rgba(11,45,85,0.08)]">
                <p className="text-[10px] uppercase tracking-[0.12em] text-slate-500">Total pengeluaran</p>
                <p className="mt-1 text-sm font-semibold text-slate-900">Rp 45.000</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-center p-10 lg:p-12">
          <div className="max-w-[420px] mx-auto">
            ...
            <h2 className="mt-3 text-2xl font-extrabold text-slate-900">Masuk ke akun</h2>
            <p className="mt-2 text-sm text-slate-500">Selamat datang kembali!</p>
            ...
            <p className="mt-3 text-right text-xs font-semibold text-sky-700">Lupa password?</p>
